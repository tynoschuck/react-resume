...
const DesktopNav: FC<{navSections: SectionId[]; currentSection: SectionId | null}> = memo(
  ({navSections, currentSection}) => {
    const baseClass =
      '-m-1.5 p-1.5 rounded-md font-bold first-letter:uppercase hover:transition-colors hover:duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-pink-500 sm:hover:text-pink-500 text-neutral-100';
    const activeClass = classNames(baseClass, 'text-pink-500');
    ...
    return (
      <>
        <button
          ...
          className="fixed top-2 right-2 z-40 rounded-md bg-pink-500 p-2 ring-offset-gray-800/60 hover:bg-pink-400 focus:outline-none focus:ring-0 focus-visible:ring-2 focus-visible:ring-pink-500 focus-visible:ring-offset-2 sm:hidden"
          onClick={toggleOpen}>
